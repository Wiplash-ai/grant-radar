  ...
  return <div className="page-shell policy-page"><SiteHeader />
    <main>
      ...
      <article className="policy-content">
        ...
        <section><span>04</span><div><h2>How the browser extension works</h2><p>The extension opens the Grant Grinder search app when you click its toolbar button. If you deliberately select text and choose the Grant Grinder context-menu command, that phrase is placed in the search URL. The extension does not read full pages, browsing history, forms, passwords, or unrelated tabs, does not inject scripts into webpages, and does not store a paid API key.</p></div></section>
        ...
        <section><span>08</span><div><h2>Cookies and local storage</h2><p>The public web app does not currently set advertising or analytics cookies. Signed-in funding desks use a secure HTTP-only session cookie. The extension can store only a configurable Grant Grinder web-app URL in browser sync storage, allowing local or self-hosted use. Your browser vendor can sync that setting according to your browser account settings.</p></div></section>
